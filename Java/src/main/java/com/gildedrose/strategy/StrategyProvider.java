...
import com.gildedrose.calculator.sellin.impl.DefaultSellInCalculator;
...
public class StrategyProvider {
    ...
    public StrategyProvider() {
        UpdateStrategy normalStrategy = new ItemUpdateStrategy(new DefaultQualityCalculator(), new DefaultSellInCalculator());
        UpdateStrategy agedBrieStrategy = new ItemUpdateStrategy(new AgedBrieQualityCalculator(), new DefaultSellInCalculator());
    ...
    private static Map<String, UpdateStrategy> getUpdateStrategyMap(UpdateStrategy agedBrieStrategy) {
        UpdateStrategy backstageStrategy = new ItemUpdateStrategy(new BackstagePassQualityCalculator(), new DefaultSellInCalculator());
